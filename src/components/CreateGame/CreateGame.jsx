        ...
        <div>
            <form onSubmit={e => handleSubmit(e)}>
                ...
                <div>
                    ...
                    <input type="date" name='releaseDate' value={input.releaseDate} onChange={handleInputChange} placeholder='dd-mm-yyyy' />
                ...
                <div>
                    ...
                    <select name='platforms' onChange={(selection) => handleSelect(selection)}>
                        <option disabled select>Seleccione los géneros</option>
                        {
                            platforms.map( p => (
                                <option value={p}>
                                    {p}
